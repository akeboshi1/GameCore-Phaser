...
export class NoticeView extends ModuleViewBase {
  ...
  protected init() {
    ...
    this._context = this.game.make.text(6, 6, "", { font: "24px " + CustomWebFonts.Fonts2DumbWebfont.getFamily(), align: "center", wordWrap: true, wordWrapWidth: 1180, boundsAlignV: "middle", fill: "#FFF"});
