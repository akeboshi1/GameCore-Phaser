...
export class SceneEditorMediator extends SceneMediator {
  ...
  private handleChangeMode(): void {
    ...
    if (em.mode === EditorType.MODE_MOVE) {
      ...
      let bounds: Phaser.Rectangle = new Phaser.Rectangle(-(mapSceneInfo.mapTotalWidth * this.view.scale.x - GameConfig.GameWidth), -(mapSceneInfo.mapTotalHeight * this.view.scale.y - GameConfig.GameHeight),
        (mapSceneInfo.mapTotalWidth * this.view.scale.x - GameConfig.GameWidth + mapSceneInfo.tileWidth * this.view.scale.x / 2), (mapSceneInfo.mapTotalHeight * this.view.scale.y - GameConfig.GameHeight + mapSceneInfo.tileHeight * this.view.scale.y));
      // Log.trace(bounds);
