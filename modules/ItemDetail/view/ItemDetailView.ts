...
export class ItemDetailView extends CommModalWindowView {
  ...
  protected init(): void {
      ...
      this.m_Icon.icon.anchor.set(0.5, 0);
      this.m_Icon.x = this.width >> 1;
      this.m_Icon.y = 60;
      this.add(this.m_Icon);

      this.m_Text = this.game.make.text(0, 0, "", {font: "bold 24px " + CustomWebFonts.Fonts2DumbWebfont.getFamily(), fill: "#FFF", align: "left", wordWrap: true, wordWrapWidth: 600});
