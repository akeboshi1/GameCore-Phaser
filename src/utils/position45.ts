...
export class Position45 {
  ...
  public static transformTo45(point3: IPoint3, position: IPosition45Obj): Phaser.Geom.Point {
    ...
    return new Phaser.Geom.Point(
      Math.floor((point3.y + point3.z) / position.tileHeight + (point3.x - offset.x) / position.tileWidth),
      Math.floor((point3.y + point3.z) / position.tileHeight - (point3.x - offset.y) / position.tileWidth),
    );
  }
}
