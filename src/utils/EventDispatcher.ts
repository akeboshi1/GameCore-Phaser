...
export class EventDispatcher {
    ...
    public on(type: string, listener: Function, caller: any, args: any[] = null): EventDispatcher {
        return this._createListener(type, caller, listener, args, false);
    }

    public once(type: string, listener: Function, caller: any, args: any[] = null): EventDispatcher {
        return this._createListener(type, caller, listener, args, true);
    }
    /**
     *
     */
    public off(type: string, listener: Function, caller: any, onceOnly: Boolean = false): EventDispatcher {
    ...
    public offAllCaller(caller: any): EventDispatcher {
