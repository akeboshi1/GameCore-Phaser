...
import { GameScroller, NineSlicePatch, Button, NineSliceButton, BBCodeText } from "apowophaserui";
...
class TaskCell extends Phaser.GameObjects.Container {
    ...
    constructor(scene: Phaser.Scene, key: string, dpr: number, zoom: number) {
        ...
        this.countTex.x = this.width * 0.5;
        this.countTex.y = this.height * 0.5 - 2 * dpr;
