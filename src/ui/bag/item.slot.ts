...
export class ItemSlot implements IItem {
    ...
    constructor(scene: Phaser.Scene, parentCon: Phaser.GameObjects.Container, x: number, y: number, resStr: string, respng: string, resjson: string, subscriptRes: string) {
        this.mScene = scene;
    ...
    private onLoadCompleteHandler() {
        ...
        itemBG.setTexture(this.mResStr, "bag_Slot");
