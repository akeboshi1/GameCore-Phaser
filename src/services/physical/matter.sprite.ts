...
export class MatterSprite {
    ...
    public getInteractive() {
        ...
        return this.getInteractiveArea(this.currentAnimationName, flip);
    }
...
export class MatterAnimationModel implements IMatterAnimationData {
    ...
    constructor(ani: any) {
        ...
        if (Array.isArray(origin)) {
            Logger.getInstance().warn(`data error (${ani.originPoint}) is Array`);
