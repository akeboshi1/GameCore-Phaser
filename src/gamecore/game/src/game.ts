...
import { IConnectListener } from "../../../structure/src/net/socket";
...
import { GameState, ILauncherConfig, LoadState, MAIN_WORKER, RENDER_PEER, PHYSICAL_WORKER, ModuleName, Logger, EventDispatcher } from "structure";
