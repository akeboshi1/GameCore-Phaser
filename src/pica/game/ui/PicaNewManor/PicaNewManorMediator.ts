...
import { PicaNewManor } from "./PicaNewManor";

export class PicaNewManorMediator extends BasicMediator {
    constructor(game: Game) {
        super(ModuleName.PICANEWMANOR_NAME, game);
        this.mModel = new PicaNewManor(this.game);
    ...
    private get model(): PicaNewManor {
        return (<PicaNewManor>this.mModel);
    }
}
