...
export class PicaNewCommonHandler extends NewProtoHandler {
    protected onAddListener() {
        ...
        this.proto.on("OP_RES_SERVER_TEST_GET_TRUMPET_MESSAGE", this.onSendNewProtoHandler, this);
    ...
    protected onRemoveListener() {
        ...
        this.proto.off("OP_RES_SERVER_TEST_GET_TRUMPET_MESSAGE", this.onSendNewProtoHandler, this);
