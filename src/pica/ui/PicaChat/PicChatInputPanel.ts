...
import { UIAtlasKey } from "../../../render/ui/Ui.atals.name";
...
class QuickChatItem extends Phaser.GameObjects.Container {
    ...
    constructor(scene: Phaser.Scene, width: number, height: number, key: string, dpr: number, first: boolean = false) {
        ...
        this.text = this.scene.make.text({ x: 0, y: 0, text: "", style: { fontSize: 13 * dpr, fontFamily: Font.DEFULT_FONT, color: "#6F6F6F" } }).setOrigin(0, 0.5);
