...
export class PicaBusinessChoosePlanPanel extends Phaser.GameObjects.Container {
    ...
    private curSelectData: any;// op_client.MarketPlan
    ...
    public setPlanData(marketPlan: any[]) {// op_client.IMarketPlan
...
class PlanTypeItem extends Phaser.GameObjects.Container {
    public palnData: any;// op_client.MarketPlan
    private key: string;
    private dpr: number;
    ...
    public setPlanData(data: any) {// op_client.MarketPlan
        this.palnData = data;
        let icon = data.icon;
