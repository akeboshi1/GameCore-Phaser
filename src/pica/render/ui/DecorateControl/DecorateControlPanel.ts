...
export class DecorateControlPanel extends BasePanel {
    ...
    private onExitHandler() {
        ...
        this.mSaving = true;
        this.render.renderEmitter(RENDER_PEER + "_" + this.key + "_exit");
    }

    private onRecycleAllHandler() {
        this.render.renderEmitter(RENDER_PEER + "_" + this.key + "_recycleAll");
    }

    private onRedoHandler() {
        this.render.renderEmitter(RENDER_PEER + "_" + this.key + "_redo");
    }

    private onShowFurniHandler() {
        this.render.renderEmitter(RENDER_PEER + "_" + this.key + "_showFurni");
    }
    ...
    private onSaveHandler() {
        ...
        this.mSaving = true;
        this.render.renderEmitter(RENDER_PEER + "_" + this.key + "_save");
    }

    private onGetDoorHandler() {
        this.render.renderEmitter(RENDER_PEER + "_" + this.key + "_getDoor");
    }
}
