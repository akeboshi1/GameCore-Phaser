...
export class PicaWorkPanel extends BasePanel {
    ...
    resize(width?: number, height?: number) {
        ...
        this.itemtips.setInvalidArea(Tool.getRectangle(this.helpBtn, this.scene));
    }
    ...
    init() {
        ...
        this.helpBtn.on(ClickEvent.Tap, this.onHelpHandler, this);
    ...
    private onHelpHandler() {
        ...
        this.itemtips.setText(i18n.t("work.worktips"));
...
class WorkItem extends Phaser.GameObjects.Container {
    ...
    constructor(scene: Phaser.Scene, key: string, dpr: number) {
        ...
        this.salaryvalue = new ImageValue(scene, 60 * dpr, 20 * dpr, this.key, undefined, this.dpr);
        ...
        this.workBtn.x = 0;
        this.workBtn.setTextStyle({ fontSize: 12 * dpr, color: "#996600", fontFamily: Font.DEFULT_FONT });
        this.workBtn.setFontStyle("bold");
...
class ProgressItem extends Phaser.GameObjects.Container {
    ...
    constructor(scene: Phaser.Scene, width: number, height: number, key: string, frame: string, title: string, dpr: number) {
        ...
        this.imgvalue = new ImageValue(scene, this.width - 20 * dpr, this.height, key, undefined, dpr);
        this.imgvalue.y = dpr;
        this.add(this.imgvalue);
        this.imgvalue.setTextStyle({ fontSize: 10 * dpr, fontFamily: Font.NUMBER });
        this.imgvalue.setTextFilter(Phaser.Textures.FilterMode.LINEAR);
