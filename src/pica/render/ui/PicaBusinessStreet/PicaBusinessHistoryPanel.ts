...
export class PicaBusinessHistoryPanel extends Phaser.GameObjects.Container {
    ...
    public setHistoryeData(datas: any[]) {// op_client.IEditModeRoom
    ...
    protected create() {
        ...
        const titleText = this.scene.make.text({
            x: posx + 30 * this.dpr, y: posy + 6 * this.dpr, text: i18n.t("business_street.history_title"),
            style: { fontSize: 13 * this.dpr, fontFamily: Font.DEFULT_FONT, color: "#FFC51A" }
        }).setOrigin(0, 0.5);
...
class PicHistoryItem extends Phaser.GameObjects.Container {
    ...
    public setStoreData(data: any) {// op_client.IEditModeRoom
        this.storeData = data;
