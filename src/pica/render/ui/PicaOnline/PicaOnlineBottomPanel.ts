...
export class PicaOnlineBottomPanel extends Phaser.GameObjects.Container {
    ...
    private blockBtn: ThreeSliceButton;
    ...
    init() {
        ...
        this.blockBtn.on(ClickEvent.Tap, this.onBlockHandler, this);
        this.content.add(this.blockBtn);
    ...
    public removeListen() {
        ...
        this.blockBtn.off(ClickEvent.Tap, this.onBlockHandler, this);
    ...
    private onBlockHandler() {
        if (this.sendHandler) this.sendHandler.runWith(["block"]);
    }
