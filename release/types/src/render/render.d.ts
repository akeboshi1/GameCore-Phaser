...
import { IPos, IPosition45Obj, Size } from "utils";
...
import { ElementStateType, GameMain, IDragonbonesModel, IFramesModel, ILauncherConfig, IScenery } from "structure";
...
export declare class Render extends RPCPeer implements GameMain, IRender {
    ...
    showEditGrids(size: IPosition45Obj, maps: number[][]): void;
    hideEditGrids(): void;
