...
var ConnectingState = /** @class */ (function (_super) {
    __extends_1(ConnectingState, _super);
    function ConnectingState(main, key) {
        return _super.call(this, main, key) || this;
    }
    ConnectingState.prototype.run = function () {
        var _this = this;
        _super.prototype.run.call(this);
        var config = this.mMain.config;
        var gateway = config.server_addr;
        if (!gateway || !gateway.host || !gateway.port) {
            this.mMain.render.showAlert("登录失败，请重新登录或稍后再试", true, false)
                .then(function () { return __awaiter(_this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.mMain.render.clearAccount()];
                        case 1:
                            _a.sent();
                            this.mGame.login();
                            return [2 /*return*/];
        ...
        if (gateway) {
            ...
            var addr = { host: gateway.host, port: gateway.port, secure: gateway.secure };
            this.mGame.connection.startConnect(addr);
        }
    };
    ConnectingState.prototype.update = function (data) {
        // 告诉主进程链接成功
    ...
    ConnectingState.prototype.next = function () {
        this.mGame.loginEnterWorld();
    };
    return ConnectingState;
}(BaseState));
export { ConnectingState };
//# sourceMappingURL=connecting.state.js.map