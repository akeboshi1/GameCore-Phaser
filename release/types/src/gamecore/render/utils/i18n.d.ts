...
export declare function ttranslate(string: string, options?: any, namespaces?: string): string;
export declare function translateProto(strMsg: op_def.StrMsg, namespaces?: string): string;
