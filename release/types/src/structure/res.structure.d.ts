...
export declare class UIHelper {
    ...
    static spliceText(maxwidth: number, text: string, fontSize: number, scene: any): string;
    static Text(scene: any): any;
    static createSprite(scene: any, key: string, animkey: string, frame: string, indexs: number[], frameRate?: number, repeat?: number, compl?: Handler): any;
