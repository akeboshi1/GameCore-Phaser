...
declare module 'game-core' {
    export { IAccountData, Account } from "game-core/game";
...
declare module 'game-core/ui/components' {
    ...
    export { IconBtn } from "game-core/ui/components/icon.btn";
...
declare module 'game-core/rooms/editor/selected.element' {
    ...
    export class SelectedElement {
        constructor(mScene: Phaser.Scene, mLayerManager: LayerManager);
